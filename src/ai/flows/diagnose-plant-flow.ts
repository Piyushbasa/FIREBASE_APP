...
const DiagnosePlantOutputSchema = z.object({
  ...
  diagnosis: z.object({
    ...
    remedy: z.string().describe('The suggested remedy for the plant\'s health issues.'),
  }),
});
...
3.  Diagnose the plant's health. Determine if it is healthy or not and set the 'isHealthy' field.
4.  Provide a clear diagnosis of any disease, pest, or nutrient deficiency.
5.  Suggest a practical, actionable remedy suitable for Indian farmers. Include both organic and chemical treatment options if applicable.
